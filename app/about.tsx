        ...
        <GradientBackground>
            <SafeAreaView style={styles.safeArea}>
                <View style={styles.header}>
                    ...
                    <Text style={[styles.title, { color: theme.textWhite }]}>ABOUT US</Text>
                </View>

                <View style={styles.content}>
                    <View style={styles.logoContainer}>
                        <Ionicons name="eye" size={80} color={theme.primary} />
                        <Text style={[styles.appName, { color: theme.textWhite }]}>DON'T BLINK</Text>
                        <Text style={[styles.version, { color: theme.textMuted }]}>Version 2.0.4</Text>
                    </View>
                    ...
                    <Text style={[styles.creditsTitle, { color: theme.primary }]}>Created by</Text>
                    <Text style={[styles.creditsName, { color: theme.textWhite }]}>The Don't Blink Team</Text>

                    <View style={styles.socials}>
                        <TouchableOpacity style={styles.socialIcon}>
                            <Ionicons name="logo-twitter" size={24} color={theme.textMuted} />
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.socialIcon}>
